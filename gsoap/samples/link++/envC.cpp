...
SOAP_SOURCE_STAMP("@(#) envC.cpp ver 2.8.1 2011-02-02 01:42:21 GMT")
...
SOAP_FMAC3 struct h__authentication * SOAP_FMAC4 soap_in_h__authentication(struct soap *soap, const char *tag, struct h__authentication *a, const char *type)
{
	...
	if (soap_s2string(soap, soap_attr_value(soap, "userid", 0), &a->userid, -1, -1))
		return NULL;
	if (soap_s2string(soap, soap_attr_value(soap, "passwd", 0), &a->passwd, -1, -1))
		return NULL;
	if (soap->body && !*soap->href)
	{
		for (;;)
